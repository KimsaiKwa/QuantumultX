...
// @version        220913
// @namespace https://greasyfork.org/users/522173
// ==/UserScript==
...
function update_bt_site(title, year, douban_ID, IMDb_ID, title_cn) {
  ...
  title = title.trim();
  sites = {
    '易搜网盘': 'https://yiso.fun/info?searchKey=' + title_cn,
    'WIKI.EN': 'https://en.wikipedia.org/?search=' + title ,
    'WIKI.中': 'https://zh.wikipedia.org/?search=' + title_cn,
    // '低端影视': 'https://www.google.com/search?q=site%3Addys.tv ' + title + ' ' + year,
    '猫狸网盘': 'https://alipansou.com/search?k=' + title_cn,
    '低端影视': 'https://ddys.tv/?s=' + douban_ID,
    //'WebHD': 'https://webhd.cc/d/' + douban_ID,
    'BT之家': 'https://www.btbtt12.com/search-index-keyword-' + title_cn + '.htm',
  }
